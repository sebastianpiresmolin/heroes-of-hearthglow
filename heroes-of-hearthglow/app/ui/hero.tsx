...
export default function Hero() {
  return (
    <section className="flex justify-center bg-gray-400 h-">
      <div
      ...
      >
        ...
        <p className="max-w-[800px] pb-20 text-xl w-[80vw] m-auto font-semibold text-white drop-shadow-[0_1px_2px_rgba(0,0,0,1)] text-shadow-xl text-center">
          ...
          Phasellus ornare consequat euismod. Curabitur sed arcu nec velit
          congue ultrices non nec massa. Donec eu cursus leo. Phasellus ornare
          consequat euismod.
        </p>
      </div>
    </section>
