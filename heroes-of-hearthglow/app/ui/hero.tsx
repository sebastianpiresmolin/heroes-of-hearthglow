  ...
  return (
      <section className="relative bg-black flex flex-col items-center h-fit outer-shadow">
        ...
        <div className="flex-col max-w-[1000px] w-full h-fit z-1">
          <div className="flex flex-col justify-start items-start mt-[600px] md:flex-row md:mt-0 md:items-center">
            <Image
              src="/landing.jpg"
              width={2400}
              height={1642}
            ...
            />
            <p className="ml-5 mt-2 w-7/8 md:leading-9 font-normal text-slate-300 drop-shadow-[0_1px_2px_rgba(0,0,0,1)] text-shadow-xl md: mr-5">
          ...
          <div className="flex flex-col justify-end items-end mt-8 md:flex-row-reverse md:items-center md:mt-16">
            ...
            />
            <p className="ml-5 mt-2 w-7/8 md:leading-9 font-normal md:text-left text-right text-slate-300 drop-shadow-[0_1px_2px_rgba(0,0,0,1)] text-shadow-xl md: mr-5">
              Fight bad dudes at badass places, like the place shown above probably. Fight bad dudes at badass places, like the place shown above probably. Fight bad dudes at badass places, like the place shown above probably. Fight bad dudes at badass places, like the place shown above probably. Fight bad dudes at badass places, like the place shown above probably.
            </p>
          </div>
          <div className="flex flex-col justify-center items-left mt-8 md:flex-row md:items-center md:mt-16 ">
            <Image
                src="/landing.jpg"
                width={2400}
                height={1642}
